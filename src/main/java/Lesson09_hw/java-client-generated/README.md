...
- API version: 0.0.1
  - Build date: 2023-02-15T12:32:25.602413532Z[GMT]
...
------------ | ------------- | ------------- | -------------
*CloudsApi* | [**cancelCloudById**](docs/CloudsApi.md#cancelCloudById) | **DELETE** /clouds/{cloud_id} | Метод отмены заказа по ID
*CloudsApi* | [**createCloud**](docs/CloudsApi.md#createCloud) | **POST** /clouds | Метод создания заказа на облако

...
public class CloudsApi {
     ...
     * @param cloudId Иденьтфикатор заказа облака (required)
    ...
    public com.squareup.okhttp.Call cancelCloudByIdCall(String cloudId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        final String[] localVarAccepts = {
            "application/json", "adplication/json"
        };
    ...
    /**
     * Метод отмены заказа по ID (asynchronously)
     * 
     * @param cloudId Иденьтфикатор заказа облака (required)
    ...
    public com.squareup.okhttp.Call createCloudCall(Error body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        final String[] localVarAccepts = {
            "adplication/json", "application/json"
        };
        final String localVarAccept = apiClient.selectHeaderAccept(localVarAccepts);
        if (localVarAccept != null) localVarHeaderParams.put("Accept", localVarAccept);
    ...
    private com.squareup.okhttp.Call createCloudValidateBeforeCall(Error body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createCloud(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Cloud createCloud(Error body) throws ApiException {
        ApiResponse<Cloud> resp = createCloudWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Cloud> createCloudWithHttpInfo(Error body) throws ApiException {
    ...
    /**
     * Метод создания заказа на облако (asynchronously)
     * 
     * @param body  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createCloudAsync(Error body, final ApiCallback<Cloud> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Resources getAllClouds() throws ApiException {
        ApiResponse<Resources> resp = getAllCloudsWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Resources> getAllCloudsWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAllCloudsAsync(final ApiCallback<Resources> callback) throws ApiException {
